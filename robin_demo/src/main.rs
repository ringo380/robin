...
use robin::engine::world::{VoxelWorld, VoxelType};
use robin::engine::build_mode::{EngineerBuildSystem, BuildMode, TemplateType};
...
// Import unified game logic from main engine
use robin::engine::{
    world::{VoxelType, construction::VoxelEngine},
    build_mode::{VoxelBuildSystem, BuildMode, TemplateType, VoxelBuildAction, VoxelBuildOperation},
    graphics::{UnifiedRenderer, RenderBackend, PlatformWindowHandle, PlatformCapabilities},
};
...
mod game {
    ...
    pub enum TemplateType {
        ...
        Castle,      // Multi-room castle structure
        Garden,      // Landscaped garden with paths
        Workshop,    // Engineer's workshop building
        Fortress,    // Defensive fortification
        Lighthouse,  // Tall lighthouse structure
        Windmill,    // Working windmill structure
    }
    ...
    impl EngineerBuildSystem {
        pub fn new() -> Self {
            ...
            inventory.insert(VoxelType::Glass, 250);
            inventory.insert(VoxelType::Metal, 500);
            inventory.insert(VoxelType::Brick, 999);
            inventory.insert(VoxelType::Ice, 200);

            // Limited special materials
            inventory.insert(VoxelType::Crystal, 100);
            inventory.insert(VoxelType::Lava, 50);
            inventory.insert(VoxelType::Obsidian, 75);
