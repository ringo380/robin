/// Minimal 3D Triangle Demo - The simplest possible 3D graphics test
/// This demo opens a real window and renders a colored triangle using wgpu
...
async fn run() {
    ...
    println!("🎮 Starting MINIMAL 3D Graphics Demo");
    println!("This should open a window with a colorful triangle!");

    let event_loop = EventLoop::new().unwrap();
    let window = WindowBuilder::new()
        .with_title("🔥 Robin Engine - Minimal Triangle Demo")
        .with_inner_size(winit::dpi::LogicalSize::new(800, 600))
        .build(&event_loop)
        .unwrap();

    println!("🖼️  Window created! Initializing graphics...");

    let mut state = State::new(&window).await;

    println!("🎯 Graphics ready! You should see a colorful triangle!");
